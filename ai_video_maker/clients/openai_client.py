...
_MODE_A_SYSTEM = (
    ...
    "present tense; preserve character identity, wardrobe, and environment "
    "except for the changes visible between the frames; no hard cuts, no new "
    "characters, no on-screen text. Do not mention frame numbers or that "
