...
_MODE_A_SYSTEM = (
    ...
    "filling both frames — the people simply hold roughly steady: they stand, "
    "turn in place, shift their weight, look around, adjust a jacket, share a "
    "look. The frames carry the change on their own. Write what the PEOPLE "
    "do; never narrate the scenery doing it for them. "
